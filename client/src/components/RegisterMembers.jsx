      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="isVisitor" className="text-gray-700">
            Is Visitor?
          </label>
        </div>
        ...
        {isVisitor && (
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="willBeComing" className="text-gray-700">
        ...
        <div>
          <label className="block text-gray-700 mb-2" htmlFor="leader">
            Leader
          </label>
          <input
            id="leader"
